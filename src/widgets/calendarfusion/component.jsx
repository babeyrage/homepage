...
export default function Component({ service }) {
  ...
  // Load active integrations — reused unchanged from ../calendar/integrations, since
  // this fork only restyles presentation, not the iCal/*arr data fetching.
          ...
          service: dynamic(
            () =>
              import(
                ...
                `../calendar/integrations/${integration.type}.jsx`
              ),
          ),
