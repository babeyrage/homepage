...
const components = {
  ...
  backrestfusion: dynamic(() => import("./backrestfusion/component")),
  ...
  calendarfusion: dynamic(() => import("./calendarfusion/component")),
  ...
  cisafusion: dynamic(() => import("./cisafusion/component")),
  ...
  dota2: dynamic(() => import("./dota2/component")),
  ...
  nvdfusion: dynamic(() => import("./nvdfusion/component")),
  ...
  patchmonfusion: dynamic(() => import("./patchmonfusion/component")),
  ...
  piholefusion: dynamic(() => import("./piholefusion/component")),
  ...
  prowlarrfusion: dynamic(() => import("./prowlarrfusion/component")),
  proxmox: dynamic(() => import("./proxmox/component")),
  proxmoxfusion: dynamic(() => import("./proxmoxfusion/component")),
  pbsfusion: dynamic(() => import("./pbsfusion/component")),
  ...
  qbittorrentfusion: dynamic(() => import("./qbittorrentfusion/component")),
  qnap: dynamic(() => import("./qnap/component")),
  radarr: dynamic(() => import("./radarr/component")),
  radarrfusion: dynamic(() => import("./radarrfusion/component")),
  readarr: dynamic(() => import("./readarr/component")),
  romm: dynamic(() => import("./romm/component")),
  rommfusion: dynamic(() => import("./rommfusion/component")),
  rutorrent: dynamic(() => import("./rutorrent/component")),
  sabnzbd: dynamic(() => import("./sabnzbd/component")),
  sabnzbdfusion: dynamic(() => import("./sabnzbdfusion/component")),
  scrutiny: dynamic(() => import("./scrutiny/component")),
  seerr: dynamic(() => import("./seerr/component")),
  seerrfusion: dynamic(() => import("./seerrfusion/component")),
  slskd: dynamic(() => import("./slskd/component")),
  sonarr: dynamic(() => import("./sonarr/component")),
  sonarrfusion: dynamic(() => import("./sonarrfusion/component")),
  sparkyfitness: dynamic(() => import("./sparkyfitness/component")),
  speedtest: dynamic(() => import("./speedtest/component")),
  speedtestfusion: dynamic(() => import("./speedtestfusion/component")),
  ...
  tracearrfusion: dynamic(() => import("./tracearrfusion/component")),
  traefik: dynamic(() => import("./traefik/component")),
  traefikfusion: dynamic(() => import("./traefikfusion/component")),
  transmission: dynamic(() => import("./transmission/component")),
  trilium: dynamic(() => import("./trilium/component")),
  tubearchivist: dynamic(() => import("./tubearchivist/component")),
  truenas: dynamic(() => import("./truenas/component")),
  unifi: dynamic(() => import("./unifi/component")),
  unififusion: dynamic(() => import("./unififusion/component")),
  unifi_drive: dynamic(() => import("./unifi_drive/component")),
  unmanic: dynamic(() => import("./unmanic/component")),
  unraid: dynamic(() => import("./unraid/component")),
  upcomingreleases: dynamic(() => import("./upcomingreleases/component")),
